...
Original file is located at
    https://colab.research.google.com/drive/1z460k0ejR6Wbvmhk_JcG0QZgeTbcGVQM
...
def get_train_augmentation_model():
    model = keras.Sequential(
        [
            ...
            layers.RandomRotation(factor=0.15), # Added
            layers.RandomZoom(height_factor=0.1, width_factor=0.1), #Added
            layers.RandomContrast(factor=0.2), # Added
            layers.RandomBrightness(factor=0.2) # Added
            layers.RandomTranslation(factor=0.2) #Added
        ],
...
def update_encoder_ratio(encoder):
  encoder.mask_proportion = random.random();
...
class MaskedAutoencoder(keras.Model):
    ...
    #     self.patch_encoder.mask_proportion = random.random()
    #     print(f"Epoch: {epoch}, Updated mask proportion: {self.patch_encoder.mask_proportion}")
    ...
    def on_epoch_begin(self, epoch, logs=None):
            self.patch_encoder.mask_proportion = random.random()  # Update here
            print(f"Epoch: {epoch}, Updated mask proportion: {self.patch_encoder.mask_proportion}")
...
class TrainMonitor(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        # self.model.patch_encoder.mask_proportion = random.random()
        # print("New Value", self.model.patch_encoder.mask_proportion)
