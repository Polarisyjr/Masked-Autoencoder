# -*- coding: utf-8 -*-
"""Adaptive_Masking_Ratio_mae_pretraining.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14u1tHvkO8RdpWn-m28nX311XRjvs-nrd
...
class TrainMonitor(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        # r = random.random()
        self.model.patch_encoder.mask_proportion = epoch/EPOCHS
        print("\nMasking Ratio: ", self.model.patch_encoder.mask_proportion)
        # print("\nRandom Masking Ratio: ", r)
